...
/*abstract */ class Player__Controller {
  ...
  static move_backward__begin(evt) {
    if (!g__Player.get().Event__move_backward__handle_fn__condt__begin) {
      return;
  ...
  static move_backward__close(evt) {
    if (!g__Player.get().Event__move_backward__handle_fn__condt__close) {
      return;
    } else if (evt.code == controller_key.GameEntityEvent__move_backward.code) {
      const l__WS_msg__body = {
        GameEntityEvent: {
  ...
  static move_left__begin(evt) {
    if (!g__Player.get().Event__move_left__handle_fn__condt__begin) {
      return;
  ...
  static move_left__close(evt) {
    if (!g__Player.get().Event__move_left__handle_fn__condt__close) {
      return;
    } else if (evt.code == controller_key.GameEntityEvent__move_left.code) {
      const l__WS_msg__body = {
        GameEntityEvent: {
  ...
  static move_right__begin(evt) {
    if (!g__Player.get().Event__move_right__handle_fn__condt__begin) {
      return;
  ...
  static move_right__close(evt) {
    if (!g__Player.get().Event__move_right__handle_fn__condt__close) {
      return;
    } else if (evt.code == controller_key.GameEntityEvent__move_right.code) {
      const l__WS_msg__body = {
        GameEntityEvent: {
  ...
  static steer_left__begin(evt) {
    if (!g__Player.get().Event__steer_left__handle_fn__condt__begin) {
      return;
  ...
  static steer_left__close(evt) {
    if (!g__Player.get().Event__steer_left__handle_fn__condt__close) {
      return;
    } else if (evt.code == controller_key.GameEntityEvent__steer_left.code) {
      const l__WS_msg__body = {
        GameEntityEvent: {
  ...
  static steer_right__begin(evt) {
    if (!g__Player.get().Event__steer_right__handle_fn__condt__begin) {
      return;
  ...
  static steer_right__close(evt) {
    if (!g__Player.get().Event__steer_right__handle_fn__condt__close) {
      return;
    } else if (evt.code == controller_key.GameEntityEvent__steer_right.code) {
      const l__WS_msg__body = {
        GameEntityEvent: {
